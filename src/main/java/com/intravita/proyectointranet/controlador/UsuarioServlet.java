...
public class UsuarioServlet { 
 ...
 public String iniciarSesion(HttpServletResponse response, HttpServletRequest request, Model model) throws Exception { /*Clase iniciarsesion*/
  ...
  if(administradorDao.login(administrador) && request.getSession().getAttribute("administradorConectado").equals(null)) {
  ...
  if(usuarioDao.login(usuario) && request.getSession().getAttribute("usuarioConectado").equals(null)) {
 ...
 //By JA
  ...
  public String recuperarCredenciales(HttpServletRequest request, HttpServletResponse response, Model model) throws Exception  {
   ...
   if (usuario.equals(null) || (!respuesta.equals(usuario.getRespuesta()))) {
